...
{%
  \leavevmode%
  \hbox{\begin{beamercolorbox}[wd=.5\paperwidth,ht=2.5ex,dp=1.125ex,leftskip=.3cm]{section in head/foot}%
  \insertshortauthor
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.5ex,dp=1.125ex,leftskip=.3cm,rightskip=.3cm plus1fil]{section in head/foot}%
    \usebeamerfont{author in head/foot}
  \insertshorttitle\hfill\insertpagenumber/ \inserttotalframenumber
  \end{beamercolorbox}}%
  \vskip0pt%
}
...
\begin{frame}{Planning -- First Gantt}

\begin{landscape}
\begin{figure}[htp] \centering{
	\includegraphics[scale=0.50, angle=270, trim=90 60 0 0]{../gantt_initial.pdf}}
\end{figure}
\end{landscape}
...
\begin{landscape}
\begin{figure}[htp] \centering{
	\includegraphics[scale=0.48, angle=270, trim=90 60 0 0]{../gantt_final.pdf}}
\end{figure}
\end{landscape}
